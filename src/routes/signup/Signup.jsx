            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" >
                <div>
                  ...
                  <input type="email" name="email" id="email" onChange={(e) => setRegisterEmail(e.target.value)} className="bg-gray-50 border border-lightGray text-gray-900 sm:text-sm rounded-lg focus:ring-darkRed focus:border-darkRed block w-full p-2.5  placeholder-gray-400 " placeholder="youremail@domain.com" required="" />
                </div>
                <div>
